...
public class ClientControllerTest extends AbstractTestController {
    ...
    public void whenFindAll_thenReturnAllClients() throws Exception{
        ...
        OrderResponse orderResponse = creteOrderResponse(1L,100L);
    ...
    @Test
    public void updateClient_thenReturnUpdateClient() throws Exception {
        UpsertClientRequest request = new UpsertClientRequest("New Client 1");
        Client updateClient = new Client(1L,"New Client 1",new ArrayList<>());
        ...
        Mockito.when(clientMapper.requestToClient(1L,request)).thenReturn(updateClient);
    ...
    public void whenFindByIDNotExistedClient_thenReturnError() throws Exception {
        Mockito.when(clientService.findById(500L))
                .thenThrow(new EntityNotFoundException("Client with ID not found"));
        ...
        String expectedResponse = StringTestUtils
                .readStringFromResource("response/client_by_by_id_not_found_response.json");
