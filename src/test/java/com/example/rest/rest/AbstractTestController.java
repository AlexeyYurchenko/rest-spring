...
public abstract class AbstractTestController {
    ...
    protected Order createOrder(Long id,Long cost,Client client) {
        return new Order(id,"Test product " + id, BigDecimal.valueOf(cost),
                client, Instant.now(),Instant.now());
    }
    protected ClientResponse createClientResponse(Long id, OrderResponse orderResponse) {
        ClientResponse clientResponse = new ClientResponse(id, "Client " + id,
                new ArrayList<>());
    ...
    protected OrderResponse creteOrderResponse(Long id, Long cost) {
        return new OrderResponse(id,"Test product " + id
