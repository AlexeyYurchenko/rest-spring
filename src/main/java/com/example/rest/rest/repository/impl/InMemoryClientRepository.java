...
public class InMemoryClientRepository implements ClientRepository {
    ...
    public Client update(Client client) {
        ...
        if (currentClient == null){
            throw new EntityNotFoundException(MessageFormat.format("Client is ID {0} not found",clientId));
        }
    ...
    public void deleteById(Long id) {
        ...
        if (client == null){
            throw new EntityNotFoundException(MessageFormat.format("Client is ID {0} not found",id));
        }
